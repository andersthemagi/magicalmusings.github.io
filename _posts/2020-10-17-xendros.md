...
Displays the users' level, total xp, and server boosting status.
...
```
<div align="center">
<img src="https://i.ibb.co/KFFVJXZ/rank-example.jpg" style = "float: center;" alt = "Rank Command Example">
</div>
